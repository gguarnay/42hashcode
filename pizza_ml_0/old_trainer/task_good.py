...
class DQNetwork:
    def __init__(self, state_size, action_size, learning_rate, name='DQNetwork'):
		...
		# Embed with with tf.Graph().as_default() as g:
...
# Reset the graph with g: ([tf.Graph().as_default() as] g:) and remove line just below
...
# Setup TensorBoard Writer  #NEEDS TO BE CHECKED  # add with g: ?
#summary_path = os.path.join(args.output_dir, 'summary')
#writer = tf.summary.FileWriter("./tensorboard/dqn/1")
### /!\ update on ML ENgine in trainer/task.py
summary_path = os.path.join(args.output_dir, 'summary')
...
# Saver will help us to save our model # Add with g: for everything till end of training
...
# [1, 64, 89] ==> squeeze to [64,89]   ... or we could have done ndmin=2 !!!
